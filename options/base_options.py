...
class BaseOptions:
    ...
    def initialize(self):
        # data params
        self.parser.add_argument('--dataroot', default="datasets/human_seg", help='path to meshes (should have subfolders train, test)')
        ...
        self.parser.add_argument('--name', type=str, default='human_seg', help='name of the experiment. It decides where to store samples and models')
